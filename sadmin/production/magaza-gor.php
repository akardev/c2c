...
<div class="container-fluid">
    <div class="card shadow mb-4 bg-dark text-white">
        <div class="card-header py-3 bg-dark text-white text-center">
            <h4 class="m-0 font-weight-bold">Mağaza Bilgileri</h4><br>
            <small>
        ...
        <div class="card-body">
            <form method="post" action="../netting/admin-islem.php">
                ...
                <div class="form-group">
                    <a onclick="return confirm('Mağazayı silmek istiyor musunuz?')" class="btn btn-danger btn-block btn-sm" href="../netting/admin-islem?magaza-basvuru=red&userId=<?php echo $usercek['userId']; ?>">Mağazayı Sil</a>
                </div>
            </form>
